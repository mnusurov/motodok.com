...
|--------|----------------|
| **Products** | Название, категория, бренд, цена, старая цена, валюта, описание, характеристики, спецификации (key→value), изображения, PDF, SEO, даты |
...
| **News** | Заголовок, дата публикации, дата обновления, изображение, SEO |
...
- Бренд — выбери из списка; товар появится на странице производителя
