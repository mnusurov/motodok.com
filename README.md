...
|--------|----------------|
| **Products** | Товары — название, категория, цена, описание, характеристики, изображения |
| **Categories** | Категории (Diagnosis, Measure, Immobilizer, Odometers, Databases) |
| **Brands** | Бренды-производители — название, логотип, страна |
| **Articles** | Статьи — заголовок, дата, текст, изображение |
| **News** | Новости — заголовок, дата, текст |
| **Services** | Услуги — название, цена, описание |
| **Pages** | Страницы (Контакты, Как купить, Документация, Прайс) |
...
- Цена указывается в долларах США (числом)
- Для товаров без цены оставь поле пустым
