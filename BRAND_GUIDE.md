...
**Файл:** `public/images/logo.svg`

Текстовый логотип «MOTODOK» + подпись «АВТОДИАГНОСТИКА».
Акцентный оранжевый на чёрном фоне.

**Использование в хедере:** текст `Motodok` без изображения (CSS-стилизация).

**Правила:**
- Не менять цвет `MOTODOK` — только `#ff6b35`
- Не искажать пропорции
- Минимальный размер: ширина 120px (экраны мобильных)
